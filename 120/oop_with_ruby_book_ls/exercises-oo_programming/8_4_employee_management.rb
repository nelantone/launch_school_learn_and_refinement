# Employee Management
# We have written some code for a simple employee management system. Each employee must have a unique serial number.
# However, when we are testing our program, an exception is raised. Fix the code so that the program works as
...
class Employee
  ...
  # private ## needs to be accessible and abbreviated_serial_number it ia used inside #to_s
  protected

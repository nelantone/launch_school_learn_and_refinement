# Bank Balance
# We created a simple BankAccount class with overdraft protection, that does not allow a withdrawal greater than
# the amount of the current balance. We wrote some example code to test our program.

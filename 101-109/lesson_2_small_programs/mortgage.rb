...
prompt("please add the loan ammount")
...
prompt("\n================================\n
Your loan ammount: #{loan_amount}\n
your percent rate is #{annual_percent_rate}% \n
yout loan duration #{loan_duration_months} in months \n
...
def total_month_interest(month_int_rate,loan_duration_months)
  (month_int_rate / (1 - (1 + month_int_rate)**(-loan_duration_months)))
end

def month_paym(loan_amount, month_int_rate, loan_duration_months)
  loan_amount * total_month_interest(month_int_rate,loan_duration_months)
end

monthly_payment = month_paym(loan_amount, month_int_rate, loan_duration_months)
total_month_interest_amount = total_month_interest(month_int_rate,loan_duration_months)
...
Total debt:
#{(monthly_payment * loan_duration_months).round(2)}\n
Only interests debt:
#{((monthly_payment * loan_duration_months).round(2) - loan_amount).round(2)}\n
